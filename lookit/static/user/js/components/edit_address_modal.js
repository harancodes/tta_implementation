...
let editAddressFormId = null

function openEditAddressModal(address_id) {
    editAddressFormId = "#addressForm"+address_id
    ...
    initEditAddressValidation(editAddressFormId)
}
...
function initEditAddressValidation(formSelector) {
